...
*/
	...
	// Draw custom main menu image
	UI_DrawNamedPic( 0, 0, 640, 480, "oatmeal/main_menu.tga" );
	...
	for (i=0; i<numdirs; i++,dirptr+=dirlen+1)
	{
		...
		UI_DrawNamedPic( x, y, 128, 32, va("mods/%s/badge.tga",dirptr) );
	...
	else
	{
		...
		UI_DrawString( 320, 414, "OATMEAL(c) 2009 Dan Hetrick", UI_CENTER|UI_SMALLFONT, color );

		UI_DrawString( 5, 480-14, va("^7OATMEAL %s (%s)",OATMEAL_VERSION,OATMEAL_CODENAME), UI_SMALLFONT, color );
		...
		//UI_DrawString( 320, 444, "read COPYING for details.", UI_CENTER|UI_SMALLFONT, color );
                ...
                //Draw version.
                UI_DrawString( 640-40, 480-14, "^70.8.1", UI_SMALLFONT, color );
